...
for batch_size in batch_sizes:
    ...
    # Use features from the encoder (without the projection head)
    simclr_model.eval()
    ...
    simclr_accuracy = linear_evaluation(encoder_forward, device, train_loader, test_loader)
...
plt.legend()
plt.grid(True)
plt.savefig("./experiments/simclr.pdf")
